                                                        ...
                                                        <?php 
                                                            ...
                                                            <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
                                                                <svg width="15" height="25" viewBox="0 0 15 25" fill="none"
                                                                    ...
                                                                    <path d="M0.982942 13.3923L12.2253 24.631C12.7186 25.123 13.5179 25.123 14.0124 24.631C14.5057 24.1389 14.5057 23.3397 14.0124 22.8476L3.66178 12.5007L14.0112 2.15378C14.5045 1.66172 14.5045 0.862477 14.0112 0.369169C13.5179 -0.122894 12.7174 -0.122894 12.2241 0.369169L0.981696 11.6077C0.495966 12.0947 0.495966 12.9065
                                                                            0.982942 13.3923Z"
                                                                        fill="white" />
                                                                </svg>
                                                            </button>
                    ...
                    <div class="contacts__phones">
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                               ...
                               <a href="<?php the_field('number_1', 675)?>"><?php the_field('number_1', 675)?></a>
                            </div>
                        </div>
                        <div class="contacts__phoneblock">
                            Телефон №2
                            <div class="contacts__phonewrap">
                               ...
                               <a href="<?php the_field('number_2', 675)?>"><?php the_field('number_2', 675)?></a>
                            </div>
                        </div>
                    </div>
                    <div class="contacts__mail">
                        Или напишите нам на почту
                          <a href="<?php the_field('mail', 675) ?>" class="header__contacts-mail"><?php the_field('mail', 675) ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div  class="contacts__feed">
                 <?php  echo do_shortcode('[contact-form-7 id="838" title="Форма отзив"]');?>
                                ...
                                foreach( $my_posts as $post ){
                                    setup_postdata( $post );
                                        ...
                                        <div class="feedslider__text">
                                             <?php the_field('reviews_discussed'); ?>
