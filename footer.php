        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="footer__social">
                    ...
                    <a href="<?php the_field('instagram', 675)?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('facebook', 675)?>" class="footer__social-item">
                    ...
                    <a href="<?php the_field('youtube', 675)?>" class="footer__social-item">
            ...
            <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                <div class="footer__contacts">
                    ...
                    <div class="footer__contacts-item">
                        ...
                        <address> <?php the_field('address_1', 675); ?><br>
                            <?php the_field('address_2', 675); ?></address>
                    </div>
                </div>
            </div>
        </div>
